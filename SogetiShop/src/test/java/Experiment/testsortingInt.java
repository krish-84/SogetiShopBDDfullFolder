...
public class testsortingInt extends MainDriver {
	...
	public static void main(String[] args) throws Exception {
		...
		WebElement subdroprown = driver
				.findElement(By.xpath("//*[@id='js-product-list-top']/div[2]/div/div[1]/div/a[5]"));
		subdroprown.click();

		Thread.sleep(3000);

		List<WebElement> currentitems = driver
				.findElements(By.xpath("// *[@id='js-product-list']/div[1]/article/div/div/div/span"));
	...
	public static boolean ascending_order(LinkedList<String> test) {
		...
		String previous = test.getFirst();// empty string
